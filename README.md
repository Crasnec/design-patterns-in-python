...
함수형 파트는 **8부 62장으로 이어지는 한 권의 책**입니다. [책의 안내·전체 목차·실행 방법](functional/README.md)에서 선수 지식, 장별 연결 질문, 종합 과제를 확인할 수 있습니다.

모든 본문 장은 표현식 중심 프로그래밍 장을 기준으로 다음 11개 절 순서를 공유합니다. 각 장에는 개념별 설명, Scala 완결 예제, Python 대응, 트레이드오프와 연습 해설이 포함됩니다.
